                ...
                {summonerError ? (
                    ...
                    <div className={"w-[1080px] my-0 mx-auto"}>
                        <div className={"h-64 overflow-hidden"}>
                            <div className={`inline-block mt-8 w-[1080px] h-52 pb-2 bg-summoner-light rounded bg-cover relative`}>
                                {matches ? (
                                <img className={"w-full h-full object-cover absolute rounded h-[18.75rem] object-[0_20%]"} src={`https://ddragon.canisback.com/img/champion/centered/${getFavoriteChamp()}_0.jpg`} />
                                ): ""}
                                    ...
                                    <table className={"w-full table-fixed border-collapse border-spacing-0 table mt-1"}>
                                        ...
                                        <thead className={"table-header-group align-middle border-collapse"}>
                                            <tr className={"table-row align-middle border-collapse border-spacing-0"}>
                                                <th className={"pl-3 pt-3 pb-3 text-left bg-summoner-dark text-summoner-gray text-xs font-normal"} scope={"col"}>
                                                    Summoner
                                                </th>
                                                <th className={"pt-3 pb-3 bg-summoner-dark text-summoner-gray text-xs font-normal"} scope={"col"}>
                                                    Played
                                                </th>
                                                <th className={"pt-3 pb-3 bg-summoner-dark text-summoner-gray text-xs font-normal"} scope={"col"}>
                                                    W-L
                                                </th>
                                                <th className={"pt-3 pb-3 pr-3 text-right bg-summoner-dark text-summoner-gray text-xs font-normal"} scope={"col"}>Win
                                                    Ratio
                                                </th>
                                            </tr>
                                        </thead>
                                ...
                                <div className={"divide-y divide-black bg-summoner-light mt-2 w-80 h-auto text-white rounded"}>
                                    ...
                                    <table className={"w-full table-fixed border-collapse border-spacing-0 table mt-1"}>
                                        ...
                                        {calculateChampFrequency()?.map((champ) => (
                                            <tr key={champ.name} className={"border-t border-solid align-middle border-black"}>
                                                <td className={"text-left pl-[12px] whitespace-nowrap text-ellipsis overflow-hidden pt-[4px] pb-[4px] m-0 table-cell"}>
                                                    <div onClick={() => goToChamp(event, champ.name)} className={"text-gray-300 text-[12px] decoration-0 cursor-pointer hover:underline"}>
                                                        <img className={"w-[24px] h-[24px] rounded-full mr-[8px] align-middle inline-block"} src={`https://ddragon.leagueoflegends.com/cdn/${version}/img/champion/${champ.name}.png`} alt={"image of champ"}/>
                                                        {champ.name}
                                                    </div>
                                                </td>
                                                <td className={"pt-1 pb-1 text-summoner-gray text-xs text-center"}>
                            ...
                            <div className={"inline-block w-[752px] mt-2 ml-2 align-top"}>
                                <div className={"divide-y divide-black bg-summoner-light w-full h-48 text-white rounded-t"}>
                                    ...
                                    <div>
                                        ...
                                        <div className={"flex flex-row gap-4"}>
                                            ...
                                            <div className={"flex flex-col items-left justify-center mt-6 mb-3"}>
                                            ...
                                            <div className={"mt-3 ml-10"}>
                                                ...
                                                <div className={"h-20 mt-5 h-20"}>
                                                    <img className={"inline-block mr-2 align-middle"} src={getFavoritePosition()?.imgUrl} alt={"image of positino"}/>
                                ...
                                <div className={"flex bg-summoner-light items-center rounded-b"}>
                                    <div className={"flex flex-col w-full h-auto mb-3 items-center"}>
                                        <span className={"text-summoner-gray"}>Match History</span>
