        ...
        <>
            <div>
                {summoner == null ? (
                    ...
                    <div>
                        <div className={"bg-summoners-light h-64 overflow-hidden"}>
                            <div className={"flex mt-10 ml-40 items-center"}>
                                <div className={"relative"}>
                                    ...
                                    <div className={"relative -mt-5 text-center text-white"}>
                                        <span className={"inline-block bg-summoners-dark leading-5 rounded-lg px-2 text-xs"}>{summoner.summonerLevel}</span>
                                    </div>
                                </div>
                                <div className={"ml-3"}>
                                    <p className={"text-white text-2xl font-bold"}>{summoner?.name}</p>
                                    <p className={"text-summoners-gray text-xs mt-2"}>Ladder Rank</p>
                                    <div className={"mt-3"}>
                                    ...
                                    <p className={"text-summoners-gray text-xs mt-2"}>Last updated:</p>
                                </div>
                            </div>
                        ...
                        <div className={"flex flex-row"}>
                            <div className={""}>
                                <div className={"divide-y divide-black bg-summoners-light mt-2 ml-40 w-80 h-auto text-white rounded"}>
                                    <div className={"h-7 flex items-center"}>
                                        <p className={"text-sm ml-2"}>Ranked Solo-Matches</p>
                                    </div>
                                    <div className={"flex flex-row"}>
                                        <div className={"flex items-center w-96 mb-2"}>
                                            <div className={"bg-summoners-dark mt-2 rounded-full flex justify-center items-center w-20 h-20 ml-2"}>
                                            ...
                                            <div className={"flex flex-col ml-2"}>
                                                ...
                                                <p className={"text-xs text-summoners-gray"}>{summoner?.solo?.leaguePoints} LP</p>
                                            </div>
                                        </div>
                                        <div className={"flex w-full justify-end items-center mr-2"}>
                                            <div className={"flex flex-col text-xs"}>
                                                <div className={"flex justify-end"}>
                                                    <p className={"text-md text-summoners-gray"}>{summoner?.solo?.wins}W {summoner?.solo?.losses}L</p>
                                                </div>
                                                <p className={"text-xs text-summoners-gray"}>Win Rate {calculateWinRate(summoner?.solo?.wins, summoner?.solo?.losses)}%</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className={"flex flex-row"}>
                                        <div className={"flex items-center w-96 mb-2"}>
                                            ...
                                            <div className={"flex flex-col ml-2"}>
                                                ...
                                                <p className={"text-xs text-summoners-gray"}>{summoner?.flex?.leaguePoints} LP</p>
                                            </div>
                                        </div>
                                        <div className={"flex w-full justify-end items-center mr-2"}>
                                            <div className={"flex flex-col text-xs"}>
                                                <div className={"flex justify-end"}>
                                                    <p className={"text-md text-summoners-gray"}>{summoner?.flex?.wins}W {summoner?.flex?.losses}L</p>
                                                </div>
                                                <p className={"text-xs text-summoners-gray"}>Win Rate {calculateWinRate(summoner?.flex?.wins, summoner?.flex?.losses)}%</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className={"divide-y divide-black bg-summoners-light mt-2 ml-40 w-80 h-96 text-white rounded"}>
                                    <div>
                            ...
                            <div className={"flex flex-col w-1/2 ml-2 mt-2 h-auto"}>
                                <div className={"divide-y divide-black bg-summoners-light w-full h-48 text-white rounded"}>
                                    <div className={"h-7 flex items-center"}>
