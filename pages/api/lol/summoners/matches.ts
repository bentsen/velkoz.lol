...
export default async (req: NextApiRequest, res: NextApiResponse) =>  {
    ...
    if(req.method === 'DELETE') {
        return await deleteMatches(req, res);
    ...
    async function deleteMatches(req: NextApiRequest, res: NextApiResponse){
        console.log("jeg fjerner matches")
       ...
       res.status(200).json("matches have been deleted")
    }
